...
La diferencia entre CTL y LTL, es que el primero se define para árboles de ejecución y el último se define para caminos de ejecución. Además, el LTL permite expresar cómo evolucionan los estados a lo largo del tiempo en una ejecución y el CTL permite combinar cuantificadores de camino con operadores temporales.
